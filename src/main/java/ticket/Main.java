 ...
 * On: 3/14/2019
 * Project: WalHomework
 * Entry point into the program, which houses the UI configuration and processing code
 */
public class Main {

    public static void main(String[] args) {
        TicketServiceImpl service = new TicketServiceImpl(5, 5, 20);
                ...
                case (3): {
                    if (heldSeats.size() > 0) {
                        ...
                        for (SeatHold heldSeat : heldSeats) {
                            System.out.println("id = " + heldSeat.getSeatHeldId() + " - " + heldSeats);
                            System.out.println();
                        }
                        ...
                        try {
                            ...
                            Optional<SeatHold> seatHold = heldSeats.stream().filter(e -> e.getSeatHeldId() == orderId).findFirst();
